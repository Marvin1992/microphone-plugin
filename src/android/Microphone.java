package com.microphone.getvolume;
...
public class MicroPhone extends CordovaPlugin 
{
  @Override
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    try 
    {
      if (action.equals("start")){
        ...
        callbackContext.error("Method not defined");
      }
    ...
    private void start(CallbackContext callbackContext) {
      webView.loadUrl("javascript:console.log('Microphone Plugin Loaded');");
